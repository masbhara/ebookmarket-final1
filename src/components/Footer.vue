    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div class="col-span-2">
          ...
          <p class="text-gray-600 mb-6">Platform jual beli ebook terpercaya dengan koleksi lengkap dan berkualitas untuk mengembangkan pengetahuan Anda.</p>
      ...
      <div class="border-t border-gray-200 pt-8 mt-8">
        <p class="text-gray-400 text-sm text-center">
          © {{ currentYear }} Ebook Store. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
...
const helpLinks = [
  { name: 'FAQ', path: '/faq' },
  { name: 'Cara Pembayaran', path: '/payment-guide' },
...
const legalLinks = [
  ...
  { name: 'Kebijakan Refund', path: '/refund' }
]
